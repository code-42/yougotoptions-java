...
public class OptionsController {
    ...
    public String index(Model model) {
        ...
        System.out.println("OC.29. index()");

        model.addAttribute("options", optionsDao.findAll());
        System.out.println("OC.32. completed model.addAttribute(optionsDao.findAll())");
    ...
    public String displayAddOptionsForm(Model model) {
        System.out.println("OC.36. displayAddOptionsForm()");
        model.addAttribute("title", "Add Options");
        model.addAttribute(new Options());
        System.out.println("OC.41. completed model.addAttribute(new Options())");
        return "options/add";
    }
